  ...
  return (
    <div className={`${zIndex} fixed top-0 w-full  mx-auto h-2 bg-black/[0.50] p-10 flex justify-between items-center`} >
      ...
      <div className="hidden md:block lg:block">
        <Link as="#" href="/" className="text-sm text-white hover:text-gray-400 px-2">
          Inicio
        </Link>
        <Link as="#sobrenos" href="#sobrenos" className="text-sm text-white hover:text-gray-400 px-2">
          Sobre nós
        </Link>
        <Link as="#" href="/" className="text-sm text-white hover:text-gray-400 px-2">
          Blog
