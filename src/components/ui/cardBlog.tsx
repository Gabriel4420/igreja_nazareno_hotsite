...
const CardBlog: React.FC = () => {
  return (
    <>
      <div className=" flex flex-col justify-center items-center w-[300px] md:w-[340px] lg:w-full  rounded-[23px] bg-white [box-shadow:'0px 4px 4px 0 rgba(0,0,0,0.25)']">
        <img
        ...
        <button className="flex justify-center items-center  gap-2.5 px-[9px] my-5 py-3 rounded-[9px] bg-[#e27617] flex-grow-0 flex-shrink-0 text-xs font-bold text-left text-white [box-shadow:'0px 4px 4px 0 rgba(0,0,0,0.25)']">
          Continuar leitura
        </button>
      </div>
    </>
